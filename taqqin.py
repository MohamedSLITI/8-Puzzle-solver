class Taqqin:
    ...
    def up(self):
        if self.zero_pos >= 3:
            a = self.zero_pos - 3
            list1 = self.move(a)
            return Taqqin(list1, a, "Up", self, self.cost + 1)
        else:
            return None
    ...
    def down(self):
        if self.zero_pos <= 5:
            a = self.zero_pos + 3
            list1 = self.move(a)
            return Taqqin(list1, a, "Down", self, self.cost + 1)
        else:
            return None
    ...
    def right(self):
        if self.zero_pos % 3 == 2:
            ...
            a = self.zero_pos + 1
            list1 = self.move(a)
            return Taqqin(list1, a, "Right", self, self.cost + 1)
    ...
    def left(self):
        if self.zero_pos % 3 == 0:
            ...
            a = self.zero_pos - 1
            list1 = self.move(a)
            return Taqqin(list1, a, "Left", self, self.cost + 1)
